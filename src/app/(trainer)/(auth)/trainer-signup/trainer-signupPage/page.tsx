...
const TrainerSignupPage = () => {
  ...
  const { error, trainer, loading } = useSelector(
              ...
              >
                ...
                <Box>
                  ...
                  <Box
                    ...
                    borderRadius={20}
                    padding={3}
                    width={{ base: "auto", md: 345 }}
                    height={150}
                  >
                    <SignatureComponent
                      style={{ width: "full", height: 120 }}
                  ...
                  <Button size={"sm"} mt={5} onClick={() => SaveSign()}>
                    Save Sign
                  </Button>
                  {formik.touched.digital_signature &&
                    formik.errors.digital_signature && (
                      <Text className="error-mesage">
                        {formik.errors.digital_signature}
                      </Text>
                    )}
                </Box>
