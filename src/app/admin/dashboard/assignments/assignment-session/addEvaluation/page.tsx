...
const addEvaluationValidationSchema = z.object({
  title: z.string().min(1, "Title is required"),
  subTitle: z.string().optional(),
  course: z.string().min(1, "Course is required"),
  file: z.string().optional(),
  image: z.string().optional(),
  evaluationTime: z.string().min(1, "Exam time is required"),
  evaluationType: z.string(),
  evaluationCode: z.string(),
  startDate: z.date(),
  endDate: z.date(),
  status: z.string(),
  evaluationLanguage: z.string(),
  ...
  evaluationRepeatCount: z.string().optional(),
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="w-full md:w-auto mt-4 md:mt-0">
                        <FormLabel>Evaluation Photo : </FormLabel>
                        <ImageUploader
