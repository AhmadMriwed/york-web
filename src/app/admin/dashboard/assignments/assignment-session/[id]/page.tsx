          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
              <div>
                ...
                <p className="text-sm text-gray-500">#{assignment.code}</p>
              </div>
              ...
              <DeleteModal
                ...
                note="This action cannot be undone. All data related to this assignment will
              ...
              <div className="flex-1">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <InfoItem
                      label="Category"
                      value={assignment.category.title}
                      icon={<MdCategory className="w-4 h-4" />}
                    />
                    <InfoItem
                      label="Duration"
                      value={`${assignment.start_date} to ${assignment.end_date}`}
                      icon={<Calendar className="w-4 h-4" />}
                    />
                    <InfoItem
                      label="Students"
                      value={assignment.students_count}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {there_is_trainer ? (
                  <EvaluationCard
                    ...
                    rate={assignment.trainer_evaluation.trainer_evaluation_rate}
                    color="blue"
                    status={
                      assignment.trainer_evaluation.trainer_evaluation_status
                    }
                    studentsRated={
                      assignment.trainer_evaluation.trainer_evaluation_students
                    }
                    period={{
                      start:
                        assignment.trainer_evaluation.trainer_evaluation_start,
                      end: assignment.trainer_evaluation.trainer_evaluation_end,
                    }}
                    showActions={true}
                    onDetailsClick={() =>
                      console.log("Trainer details clicked")
                    }
                    onExportClick={() => console.log("Trainer export clicked")}
                    onToggleStatus={() => console.log("Trainer status toggled")}
                    onEditClick={() => console.log("Trainees status toggled")}
                  />
                ) : (
                  <>
                    <AddNewItem
                ...
                {there_is_trainee ? (
                  <EvaluationCard
                    ...
                    rate={
                      assignment.trainees_evaluation.trainees_evaluation_rate
                    }
                    color="green"
                    status={
                      assignment.trainees_evaluation.trainees_evaluation_status
                    }
                    period={{
                      start:
                    ...
                    onExportClick={() => console.log("Trainees export clicked")}
                    onToggleStatus={() =>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {there_is_preExam ? (
                  <ExamCard
                    ...
                    endDate="2024-01-15"
                    ratedStudents={18}
                    onViewDetails={() => console.log("View Pre-Exam Details")}
                    onEdit={() => console.log("Edit Pre-Exam")}
                    onDelete={() => console.log("Delete Pre-Exam")}
                    onToggleStatus={() => console.log("Toggle Pre-Exam Status")}
                ...
                {there_is_postExam ? (
                  <ExamCard
                    ...
                    endDate="2024-02-15"
                    ratedStudents={22}
                    onViewDetails={() => console.log("View Post-Exam Details")}
