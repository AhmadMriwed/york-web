            ...
            >
              ...
              <div className=" px-6 grid grid-cols-1 sm:grid-cols-7 gap-6 max-sm:px-4 max-sm:gap-4 pt-4">
                ...
                <div className=" sm:col-span-4   space-y-1 sm:space-y-4  ">
                  ...
                  <div className="flex items-center gap-3 md:gap-5">
                    ...
                    {assignmentData?.number_of_questions && (
                      <InfoItem
                        icon={
                  ...
                  <div className="flex items-center gap-3 md:gap-4">
                    {assignmentData?.number_of_students && (
                      <InfoItem
                        icon={
                    ...
                    {assignmentData?.grade_percentage && (
                      <InfoItem
                        icon={
              ...
              <div className="grid grid-cols-1 gap-4 sm:gap-5 md:grid-cols-2 p-1.5 mt-8 sm:mt-16">
                {assignmentData?.start_forms[0]?.id && (
                  <div className="bg-white dark:bg-gray-900 max-h-[450px] p-4 sm:p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-lg transition-all duration-300">
                    <div className="flex justify-between items-start">
                        ...
                        {[
                          {
                            ...
                            action: () =>
                              router.push(
                                `/admin/dashboard/assignments/assignment-session/${id}/evaluations/${evaluation_id}/start-interface/${assignmentData?.start_forms[0]?.form_id}`
                              ),
                          },
                          {
                            icon: (
                            ...
                            action: () =>
                              router.push(
                                `/admin/dashboard/assignments/assignment-session/${id}/evaluations/${evaluation_id}/start-interface/${assignmentData?.start_forms[0]?.form_id}/update`
                              ),
                          },
                          {
                            icon: (
                            ...
                            action: () => {
                              if (assignmentData)
                                deletteStartForm(
                                  Number(assignmentData?.start_forms[0].form_id)
                                );
                            },
                          },
                        ].map((item, index) => (
                        ...
                        {[
                          {
                            ...
                            action: () =>
                              router.push(
                                `/admin/dashboard/assignments/assignment-session/${id}/evaluations/${evaluation_id}/end-interface/${assignmentData?.end_forms[0]?.form_id}`
                              ),
                          },
                          {
                            icon: (
                            ...
                            action: () =>
                              router.push(
                                `/admin/dashboard/assignments/assignment-session/${id}/evaluations/${evaluation_id}/end-interface/${assignmentData?.end_forms[0]?.form_id}/update`
                              ),
                          },
                          {
                            icon: (
            ...
            <div className="xl:col-span-1 ">
              ...
              >
                ...
                >
                  ...
                  <AccordionContent>
                    {isEdittingExamRequirments ? (
                      <div>
                        <div className="">
                          <table className="w-[400px] xl:w-full border-none">
                            <tbody className="divide-y divide-gray-300  dark:divide-gray-600">
                              <tr className="">
                                <th className="px-3 py-3 xl:px-2  text-left font-medium  border-none">
                                  Id
                                </th>
                                <td className="px-3 py-3 xl:px-2  text-left  border-none">
                                  number
                                </td>
                                <td className="px-3 py-3 xl:px-2  text-left  border-none">
                                  {" "}
                          ...
                          {isThereAddFieldForExamRequirments && (
                            <Form {...formForRequirments}>
                              <form
                                onSubmit={formForRequirments.handleSubmit(
                                  onSubmitExamRequirments
                                )}
                              ...
                              >
                                    ...
                                    <FormItem>
                                      ...
                                      >
                                        ...
                                        <SelectContent className="dark:!bg-gray-800">
                                          ...
                                          <SelectItem value="email address">
                                            email address
                                          </SelectItem>
                                        </SelectContent>
                                      </Select>
                                ...
                                <div className="flex items-center justify-end mt-3">
                                  <Button
                                    ...
                                    className="py-0 !bg-primary-color1 !px-4"
                                  >
                                    <h4 className="tracking-wide py-0 my-0">
                                      Add
                                    </h4>
                                  </Button>
                                </div>
                          ...
                          {!isThereAddFieldForExamRequirments && (
                            <div className="w-full flex items-center justify-end mt-4 gap-3">
                              ...
                              <Button
                                ...
                                className="py-0 !bg-primary-color1 !px-4"
                                onClick={() => {
                                  setIsEdittingExamRequirments(false);
                                  setIsThereAddFieldForExamRequirments(false);
                                }}
                              >
                                <h4 className="tracking-wide py-0 my-0">
                          ...
                          <table className="w-[300px] xl:w-full border-none">
                            <tbody className="divide-y divide-gray-300  dark:divide-gray-600">
                              <tr className="">
                                ...
                                <td className="px-3 py-3 xl:px-2 text-right  border-none">
                                  number
                                </td>
                              </tr>
