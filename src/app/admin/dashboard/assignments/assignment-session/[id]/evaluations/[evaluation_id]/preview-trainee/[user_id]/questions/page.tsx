...
const AdminPreviewTraniee = () => {
  ...
  const handleNext = () => {
    if (currentPage < totalPages) {
      ...
      router.push(
        `/admin/dashboard/assignments/assignment-session/${id}/evaluations/${evaluation_id}/preview-trainee/${user_id}/result`
      );
    }
  };
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      <div className="shadow-sm border-b dark:border-none bg-white ">
      ...
      <div className="bg-white border-t dark:border-gray-300 py-3 px-4 sm:px-6 shadow-sm">
