...
const QuestionCreator: React.FC = () => {
  ...
  const [questionData, setQuestionData] = useState<QuestionData>({
    ...
    correctAnswerGrade: questionsTypeForAll === "6" ? 5 : 1,
    wrongAnswerGrade: 0,
    hint: "",
    required: true,
    showGrade: true,
    ...
    setQuestionData({
      ...
      correctAnswer:
        newType === "true-false"
          ...
          ? ""
          : undefined,
      correctAnswerGrade: newType === "rating-scale" ? 5 : 1,
    });
  };
  ...
  const handleRatingChange = (value: number) => {
    ...
    handleInputChange("correctAnswerGrade", value); // Update the grade to match the rating
  };
  ...
  const mapToBackendFormat = (): BackendQuestionRequest => {
    ...
    if (["single-select", "multi-select"].includes(questionData.type)) {
      ...
      // Modified for rating-scale
      fields = [questionData.correctAnswer || 5]; // Store the selected value directly
      fieldTypes = ["number"]; // Set field type to number
      correctValues = [null]; // Set correct value to null
    } else {
  ...
  const validateForm = () => {
    ...
    switch (questionData.type) {
      ...
      case "multi-select":
        ...
        break;
      case "rating-scale":
        // No validation needed since correct_answer will be null
        break;
    }
                        ...
                        <div className="flex items-center gap-4">
                          <div className="w-full">
                            <input
                              ...
                              step="1"
                              value={
                                (questionData.correctAnswer as number) || 5
                              }
                              onChange={(e) =>
