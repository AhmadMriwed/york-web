    ...
    const fetchQuestion = async () => {
      ...
      try {
        ...
        if (questionType === "short" || questionType === "long") {
          ...
          // For rating-scale, use the first field as description text if it exists
          options =
            data.fields && data.fields.length > 0
              ? [{ text: data.fields[0].field || "", isCorrect: false }]
    ...
    const formData = {
      ...
      fields:
        questionData.type === "rating-scale"
          ? [String(questionData.correctAnswer || 5)] // Store the rating value directly
      ...
      correct_value:
        ...
        questionData.type === "long" ||
        questionData.type === "short"
          ? [] // Set correct_value to empty array (null)
          : questionData.options
    ...
    <div className="bg-gray-100 dark:bg-gray-900 my-3 mx-1 sm:mx-2 rounded-lg px-1 sm:px-4 py-2 min-h-screen">
      ...
      >
        <div className="space-y-6">
          ...
          {questionData.type === "rating-scale" && (
            <div className="space-y-6">
              {/* Rating scale for correct answer */}
                    ...
                    <div className="w-full">
                      ...
                      <div className="mt-4 text-start">
                        <span className="text-sm font-bold text-primary-color1 dark:text-primary-color1-light">
                          Selected: {Number(questionData.options[0].text) || 1}
                        </span>
                      </div>
                    </div>
                  </div>
