...
import { fetchAssignmentById, fetchAssignmentByUrl } from "@/lib/action/assignment_action";
import {
  ...
  useEffect(() => {
    const fetchExamData = async () => {
      try {
        ...
        const assignmentData = await fetchAssignmentById(Number(assignment_id));
  ...
  const handleSubmit = async () => {
    setPendingAction(() => async () => {
      try {
        ...
        router.push(`/admin/dashboard/assignments/assignment-session/${id}/assignments/${assignment_id}/preview/result`);
      } catch (error) {
