...
const LifeSession = ({ params }: any) => {
  ...
  return (
    <div className="px-6 py-4">
      ...
      />
      {/* TOP BAR */}
      <div className="flex justify-between items-center flex-wrap my-[1rem]">
        <h3 className="text-[20px] font-bold flex items-center gap-3">
          <BackBtn textColor="" /> Actions:
        </h3>
      ...
      <div className="flex flex-col xl:flex-row gap-3">
        ...
        ${mode === "dark" ? "bg-[#212A34]" : "bg-white"}`}
        >
          <div className="flex flex-wrap sm:justify-between items-center gap-3 sm:gap-11">
          ...
          <div className="mt-3 flex flex-wrap sm:flex-nowrap justify-between items-center">
            <div>
        ...
        >
          ...
          <div>
            ...
            sessionInfo.session_status === "Expierd" ? (
              ...
              flex justify-center items-center font-bold text-[18px]"
              >
                GIF
              </div>
            ) : (
