    ...
    <section>
      <div className="bg-[var(--dark-bg-color)] w-full p-3 sm:p-7 flex flex-col lg:flex-row justify-evenly items-center gap-7">
        <div className="text-white">
          ...
          <div className="flex justify-between items-center mt-4">
            <div className="flex items-center gap-2">
              <div className="bg-black text-white w-fit py-[1.5px] px-[12px] sm:py-[3px] flex justify-center items-center gap-1 rounded-full">
                <CiLocationOn />
                <p className="xs: text-[10px] sm:text-[12px]">Venue</p>
              </div>
              <div className="bg-black text-white w-fit py-[1.5px] px-[12px] sm:py-[3px] flex justify-center items-center gap-1 rounded-full">
                <CiLocationOn />
                <p className="xs: text-[10px] sm:text-[12px]">Location</p>
              </div>
            </div>
          ...
          <p className="mt-2 text-[12px]">course ad code: #222333</p>
        ...
        <div className="order-first lg:order-last">
              ...
              {[1].map((item) => (
                <TrainerInfo
                  ...
                  trainer={{
                    ...
                    id: "226",
                    about_me:
                      "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Assumenda eos vitae quia quam magni impedit, porro incidunt repudiandae ex alias voluptate",
                    phone_number: "0935476555",
          ...
          <div className="mt-4">
            ...
            <p className="sm:max-w-[325px] text-[12px] text-[#888]">
              ...
              Assumenda eos vitae quia quam magni impedit, porro incidunt
              repudiandae ex alias voluptate, consequuntur ipsam rerum facere
              saepe cupiditate at ipsum mollitia.
            </p>
          </div>
        </div>
      </div>
