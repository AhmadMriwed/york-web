...
const TrainerLogin = () => {
  ...
  const { error, loading, trainer } = useSelector(
    (state: any) => state.trainerSlice
  );
            ...
            <div className="flex min-w-[100vw] min-h-[100vh] items-start justify-between px-8 py-4">
              ...
              <div className="flex items-center justify-center absolute w-full h-full top-0 right-0  md:top-[50%] md:right-[10.75rem] md:translate-y-[-50%]  md:w-[450px] md:h-[calc(100vh-2rem)] md:rounded-[9px] bg-[rgba(19,24,30,0.9)]">
                <div className="flex flex-col items-center md:items-start w-[calc(100%-4rem)] h-[calc(100%-4rem)] py-8 px-8 text-[#fff]">
                  ...
                  <p className="text-[27px] font-bold pb-9 text-center">
                  ...
                  >
                    <span className="text-base tracking-widest mb-3">
                      Welcome Back!
                    </span>
                    <input
                      type="email"
                    ...
                    <Link
                      href="/trainer-login/recoverpassword"
                      className="justify-self-end hover:no-underline"
                    >
                      <span className="text-sm tracking-widest leading-8 text-[#16FACD]">
                    ...
                    <p className="justify-self-center mt-2">
                      Not a Member ?{" "}
                      <Link
                        href="/trainer-signup"
                        className="text-[#16FACD] underline hover:text-[#16FACD]"
                      >
                        Sign Up
                      </Link>
                    </p>
