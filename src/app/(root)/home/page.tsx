...
export default function Home() {
  ...
  const CategoryCard = ({ item }: { item: category }) => (
    <div className=" col-span-1   flex justify-center items-center gap-3 flex-col p-5 md:p-[20px] w-40 h-32 md:w-[230px] md:h-[160px] bg-[var(--home-color)] rounded-[10px] hoverEffect cursor-default">
