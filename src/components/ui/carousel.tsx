...
function CarouselNavigation({
  ...
  return (
    <div
      className={cn(
        "pointer-events-none absolute left-[-10.5%] top-1/2 flex w-[125%] -translate-y-1/2 justify-between px-2",
        className
      )}
    >
      <button
        ...
        {Array.from({ length: itemsCount }, (_, i) => (
          <button
            ...
            className={cn(
              ...
              index === i
                ? "bg-primary-color2 dark:bg-zinc-50"
                : "bg-gray-400 dark:bg-zinc-100/50",
              classNameButton
            )}
          />
        ))}
