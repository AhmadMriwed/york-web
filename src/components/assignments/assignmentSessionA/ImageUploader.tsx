...
//   return (
//     <div
//       className="w-full dark:bg-gray-700 mt-3 px-3 min-h-24 sm:min-h-32  rounded-[8px] dark:text-gray-300 border-[1px] border-dashed border-black dark:border-zinc-300 bg-transparent
...
const ImageUploader = ({ formikProps }: any) => {
  ...
  return (
    <div
      className="w-full dark:bg-gray-700 mt-3 px-3 min-h-24 sm:min-h-32 rounded-[8px] dark:text-gray-300 border-[1px] border-dashed border-black dark:border-zinc-300 bg-transparent cursor-pointer flex justify-center items-center"
