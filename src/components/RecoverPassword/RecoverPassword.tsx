...
const RecoverPassword = ({title }: PasswordTitleProps) => {
  ...
  return (
    <>
    <p className='py-5 text-xl font-bold text-white tracking-wider leading-8'>Password Recovery: {title}</p>
    <div className='flex items-center justify-center h-[calc(100vh-142px)]'>
      <form onSubmit={formik.handleSubmit} className='border-l-2 border-[#01989F] md:w-[450px] p-8'>
        ...
        { title === 'Password Change' && 
            ...
            <button type='submit' className='colored-btn'>submit</button>
            </>
        }
