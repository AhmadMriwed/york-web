...
const UpdatePasswordModal = ({ isOpen, onClose, onOpen, type }: ModalType) => {
    ...
    const handleUpdatePass = async (values: any, actions: any) => {
        if (type === "trainer") {
            ...
            try {
                dispatch(trainerUpdatePassword({ token, data: values })).then((res: any) => {
                    console.log(res)
                    toast({
                        title: 'Success',
            ...
            console.log(token)
            try {
                dispatch(userUpdatePassword({ token, data: values })).then((res: any) => {
                    if (res.error) {
            ...
            console.log(token)
            try {
                dispatch(adminUpdatePassword({ token, data: values })).then((res: any) => {
                    if (res.error) {
                        console.log("some thing went wrong")
                        toast({
                            title: 'Error.',
