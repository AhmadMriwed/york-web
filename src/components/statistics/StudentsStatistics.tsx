      ...
      <div>
        <div className="flex items-end w-full h-[200px]">
          <div className="h-full flex flex-col-reverse justify-between w-[28px]">
            {hours.map((hour) => {
              return (
                <div key={hour} className="text-center py-[5px] text-[#A7A7A7]">
                  {hour} h
                </div>
              );
            })}
          ...
          <div
            className={`flex justify-evenly grow h-full px-[10px] pt-1 border-b ${
              mode === "dark" ? "border-b-[#222222]" : "border-b-[#EAEAEA]"
            } `}
          >
            {days.map((day) => {
              return (
                ...
                >
                  <Whisper
                    ...
                    trigger="hover"
                    speaker={<Tooltip>Completed: {day.completed} h</Tooltip>}
                  >
                    <div
                  ...
                  <Whisper
                    ...
                    controlId="control-id-hover"
                    trigger="hover"
                    speaker={<Tooltip>Declined : {day.declined} h</Tooltip>}
                  >
                    <div
                  ...
                  <Whisper
                    ...
                    trigger="hover"
                    speaker={
                      <Tooltip>certificated : {day.certificated} h</Tooltip>
                    }
                  >
                    <div
        ...
        <div className="mt-[25px]">
          <div className="flex justify-around items-center gap-2 flex-wrap  ">
            <div className="text-[#405053]">
              <p className="text-[17px] leading-[1.2] font-light ">Total</p>
    ...
    <div className="p-2 sm:p-6 pb-3 flex gap-x-3 gap-y-5  flex-wrap">
      <div className="grow">
        <header className="flex justify-between items-center gap-3">
          ...
          <h3 className="text-[26px] leading-[1.3] text-[#FEC700]">1,431</h3>
        </header>
